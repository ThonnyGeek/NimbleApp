...
////                    .transition(.asymmetric(insertion: viewModel.fisrtStepOptionSelected != nil ? .opacity.animation(.easeInOut(duration: 1)) : .move(edge: .leading), removal: .move(edge: .leading)))
...
//            Button {
//                withAnimation {
//                    viewModel.fisrtStepOptionSelected = HomeFirstStep.somewhatFulfilled.text
//                }
//            } label: {
//                Text("Start survey")
